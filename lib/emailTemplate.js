...
/** A consistent WhatsApp button block, reusable anywhere a CTA is needed. Never prints the number as visible text. */
export function whatsappButton(prefilledText, label = 'Chat with our team on WhatsApp') {
  const link = `https://wa.me/254780228067?text=${encodeURIComponent(prefilledText)}`;
  return `
    <table role="presentation" cellpadding="0" cellspacing="0" style="margin:6px 0 30px;">
      <tr>
        <td style="background:#25D366;border-radius:100px;">
          <a href="${link}" style="display:inline-block;padding:14px 28px;font-family:Arial,Helvetica,sans-serif;font-size:15px;font-weight:bold;color:#ffffff;text-decoration:none;">
            💬&nbsp;&nbsp;${label}
          </a>
        </td>
      </tr>
