...
const STRINGS = {
  ...
  hero_cta_browse: { en: 'Browse live roles →', sw: 'Ona nafasi za sasa →', fr: 'Voir les offres en direct →', ar: 'تصفح الوظائف المتاحة ←' },
  alert_section_eyebrow: { en: "Don't see your role yet?", sw: 'Bado hujaona nafasi yako?', fr: "Vous ne voyez pas encore votre poste ?", ar: 'لم تجد وظيفتك بعد؟' },
  alert_section_heading: { en: "Get notified the moment it's posted.", sw: 'Utaarifiwa mara itakapotangazwa.', fr: 'Soyez informé dès sa publication.', ar: 'سيتم إعلامك بمجرد نشرها.' },
